...
const dailyFlow = [
  ...
  { title: "候補を反映する", body: "分解や保留はまとめて反映できます。削除だけは事故防止のため、1件ずつ確認してから反映します。" },
...
const mobileFlow = [
  ...
  { icon: CalendarClock, title: "予定へ入れる", body: "タスク画面のGoogleボタンでGoogleカレンダー作成画面を開けます。ICSも残しているので、他のカレンダーにも取り込めます。" },
